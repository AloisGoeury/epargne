                    ...
                    void (function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _b.trys.push([0, 3, , 4]);
                                    raw = Buffer.concat(chunks_1).toString("utf8");
                                    parsed = JSON.parse(raw);
                                    return [4 /*yield*/, fs.mkdir(fileURLToPath(new URL("./.local", import.meta.url)), { recursive: true })];
                                case 1:
                                    _b.sent();
                                    return [4 /*yield*/, fs.writeFile(localDataFile, "".concat(JSON.stringify(parsed, null, 2), "\n"), "utf8")];
                                case 2:
                                    _b.sent();
                                    res.statusCode = 204;
                                    res.end();
